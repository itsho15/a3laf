        ...
        <div class="content-meta">
            <div class="d-flex justify-content-between">
                ...
                <span class="meta-date">
                    <i class="far fa-clock"></i> {{ $ad->created_at->diffForHumans() }}
                </span>
                <div class="meta-price d-block">
                    {{ __('models/ads.fields.price') }}: <span>{{ $ad->price }} {{ __('models/ads.fields.ryal') }}
                </div>
                {!! Form::open(['route' => ['front.ads.destroy', $ad->id], 'method' => 'delete']) !!}
                     <a href="{{ url('ads/'.$ad->id.'/'.str_slug($ad->name,'-')) }}" class='btn btn-success'>
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{ route('front.ads.edit', $ad->id) }}" class='btn btn-info'>
